...
public class PanelFunction extends EnableCallMiniMax implements FunctionHandler {
    ...
    /*Set the status of the board panes
    *when the game first starts
    *Board panes are locked until accessible to do so
    */
    @Override
    ...
    /*Set which boardpane belongs to the 
    *computer,to the human, and the ones that are
    * free, when the game first starts
    */
    @Override
    ...
    /*
    *returns human kings neighbors if a men became a king 
    * otherwise, it would return only human neighbors 
    */
    @Override
    ...
    // a list to return the human neighbors
    @Override
   ...
   // a list to return the computer neighbors
    @Override
    ...
    /*
    *resets panel - receives human neighbors, and if 
    *neighbors are empty(no men on them )
    *then update boardpane(under the neighbors)
    *to moveable, as no men are blocking the way 
    *
    */
    @Override
    ...
    /*
     * Human Player getScoreNode: minimax reflection method allows selected
     * node and target node of the computer player to be passed and then it lists the
     * depth nodes of the selected node,checks if listed node is empty then
     * lists depth node of the empty node, and it finally checks if listed node is
     * equal to target node,then return value
     *
     * @param clickedNode : selected node
     * @param neighbourNode : target node
     * returns depth node of the clicked node
     */
    @Override
    ...
    //a list to return the human kings 
    @Override
    ...
    // a list to return the computer kings
    @Override
    ...
    /*
    *passes clicked node and panel depth
    *if the status of the player is king, and the value
    *of the clicked node is greater than depth node
    *then it returns the computer neighors, otherwise
    *it returns the human neighbors
    */
    @Override
    ...
    /**
     * Checks nodes of human player and it gets the
     * neighbours which are empty and depth node to board pane node
     *
    ...
    /*
    * checks if the clicked node is
    *equal to its depth node 
    *
    *
    */
    @Override
