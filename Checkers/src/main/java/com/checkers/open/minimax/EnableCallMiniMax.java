...
public class EnableCallMiniMax implements CallMiniMax {
    ...
    // a list to return the human depths 
    @Override
    ...
    /* a list to return the king depths 
    *
    *Both human and AI use the same king depth
    */
    @Override
    ...
    /*if it's a king, then it return the depth 
    *node of the human king, otherwise
    * it returns just the depth node for the human men
    */
    @Override
    ...
    /* if it's a king, then it return the depth
    *node of the AI king, otherwise
    * it returns the depth node for the cimputer men
    */
    @Override
    ...
    // a list to return the computer depths 
    @Override
